...
#define h _mlhh
 ...
 static int _hoc_subtree_traverse();
	...
	Prop *_prop;
{
 ...
 _childa_reg() {
  ...
  _initlists();
 	...
 	ivoc_help("help ?1 childa /Users/boris/git/l5pyr/dendritica/batch_back/back/mod/kvz_naz/x86_64/childa.mod\n");
 }
static int _reset;
